...
import BaseFinalContainer from './containers/BaseFinalContainer'
...
class App extends Component {
  render() {
    return (
      ...
      <Route exact path="/meeting_range/:id" render={(props) => <BaseFinalContainer {...props}/>}/>
      <Route exact path="/meeting_range/:id/:type" render={(props) => <BaseFinalContainer {...props}/>}/>
